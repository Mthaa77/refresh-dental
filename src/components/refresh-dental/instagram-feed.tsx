...
const instagramImages = [
  {
    ...
    alt: 'Proud graduate of Sefako Makgatho Health Sciences University. Every smile we transform starts with a foundation of excellence in education.',
    aspect: 'aspect-[3/4]',
    likes: 312,
    comments: 18,
  },
  {
    ...
    alt: 'Clinical precision meets compassionate care. This is what exceptional dentistry looks like at Refresh Dental.',
  ...
  },
  {
    ...
    alt: 'Making dental visits fun for our little patients! Building healthy habits early at Refresh Dental, Centurion.',
    aspect: 'aspect-[4/3]',
    likes: 489,
    comments: 34,
  },
  {
    ...
    alt: 'This is why we do what we do. Your smile is our greatest reward.',
    aspect: 'aspect-[3/4]',
    likes: 178,
    comments: 8,
  },
  {
    ...
    alt: 'Meet the team behind your healthiest smile. Dedicated professionals, exceptional results.',
    aspect: 'aspect-square',
    likes: 356,
    comments: 22,
  },
  {
    ...
    alt: 'Transforming smiles one bracket at a time. Custom orthodontic solutions at Refresh Dental.',
    aspect: 'aspect-[4/3]',
    likes: 421,
    comments: 27,
  },
