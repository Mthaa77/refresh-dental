        ...
        >
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="font-jost text-xs font-medium uppercase tracking-[0.15em] text-brown-warm/60">
                    Google Reviews
                  </span>
                </div>
                ...
                {/* Review count */}
                <p className="font-jost text-sm text-brown-warm/70 mb-6">
                  Based on{' '}
          ...
          <div className="hidden md:flex flex-col gap-4 flex-shrink-0">
            {[
              ...
              >
                <span className="font-jost text-xs text-brown-warm/50 w-20 text-right">
                  {item.label}
                </span>
