    ...
    <section id="contact" className="relative isolate overflow-hidden bg-espresso py-24 text-ivory sm:py-32">
      ...
      <div className="relative mx-auto grid max-w-[1440px] gap-14 px-6 sm:px-10 lg:grid-cols-[0.88fr_1.12fr] lg:items-start lg:gap-20 lg:px-16 xl:px-20">
        <motion.div initial={{ opacity: 0, x: prefersReducedMotion ? 0 : -22 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: '-100px' }} transition={{ duration: 0.75, ease: [0.22, 1, 0.36, 1] }}>
          ...
          <h2 className="mt-4 max-w-2xl font-cormorant text-[clamp(3.5rem,6.2vw,6.8rem)] font-light leading-[0.84] tracking-[-0.055em] text-ivory [text-shadow:0_8px_28px_rgba(0,0,0,0.28)]">A better dental visit<br /><span className="bg-gradient-to-r from-teal-light via-sky-300 to-gold-pale bg-clip-text text-transparent [text-shadow:0_10px_32px_rgba(45,212,191,0.18)]">can start today.</span></h2>
          <p className="mt-7 max-w-xl font-jost text-base font-light leading-8 text-ivory/72 sm:text-lg">Tell us what you need, what has been on your mind, or just that you are ready to feel better about your smile. We will guide you to the right next step.</p>
