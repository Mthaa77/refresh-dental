          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="relative flex items-center justify-center gap-2 bg-[#25D366] text-white font-jost font-semibold rounded-xl px-6 py-3.5 w-full hover:bg-[#20BD5A] transition-colors shadow-red z-10"
              >
