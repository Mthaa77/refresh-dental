        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-10">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="flex items-center justify-center gap-2 bg-[#25D366] text-white font-jost font-semibold rounded-xl px-6 py-3.5 w-full hover:bg-[#20BD5A] transition-colors shadow-sm"
            >
            ...
            <motion.div
              ...
              className="bg-warm-blush/20 border border-warm-blush/40 rounded-2xl p-5 space-y-2"
            >
              ...
              <p className="font-jost text-sm text-brown-warm/70 leading-relaxed">
                Dr. Malunga is available for urgent cases. Call immediately for same-day appointments.
              </p>
              <a
                href="tel:0614164649"
                className="inline-flex items-center gap-2 mt-2 bg-champagne-gold text-white font-jost font-semibold rounded-full px-5 py-2 text-sm hover:bg-[#b8964f] transition-colors"
              >
